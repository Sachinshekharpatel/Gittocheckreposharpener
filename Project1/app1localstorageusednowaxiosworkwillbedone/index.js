...
// axios.get("https://crudcrud.com/api/5c7977e443f848e5a7c495a33455339b/usersdetails")
//      .then((res)=>{
//       let x = res.data;
//       // console.log(x);
...
//         let deletebtn = `<button onclick="deletedata(${x[i].value})">DeleteItem</button>`
...
//         div.innerHTML = div.innerHTML + deletebtn ;
...
//      axios.post("https://crudcrud.com/api/5c7977e443f848e5a7c495a33455339b/usersdetails",obj)
//      .then((res)=>{
...
//         // editbtn.style.marginLeft='30px' ;
//         // let dltbtn = document.createElement('button');
//         let deletebtn = `<button onclick="deletedata(${x[i]._id})">DeleteItem</button>`
//         // dltbtn.innerText = "Delete Item";
//         // dltbtn.addEventListener("click",function(){
//         //   deletedata(x[i]);
//         // })
